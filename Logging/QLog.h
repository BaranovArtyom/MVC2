...
// Flushes any pending log entries to the logEntries array and also, if  appropriate, to the log file or stderr.
- (void)flush;                                                                  // main thread only
    
// Empties the logEntries array and, if appropriate, the log file.  Not  much we can do about stderr (-:
