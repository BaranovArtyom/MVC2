...
// Called in response to the NSUserDefaultsDidChangeNotification notification.   This simply calls -setupFromPreferences to re-read our preferences.
...
//Символ ... (троеточие) в заголовке функции обозначает переменный (возможно пустой) список аргументов.
...
// Flattens the supplied array of log entries to a data object containing  LF terminated UTF-8 strings.
