...
// Called when the HTTP operation to GET the photo's thumbnail completes. If all is well, we start a resize operation to reduce it the appropriate  size.
...
// Called when the operation to resize the thumbnail completes.  If all is well, we commit the thumbnail to our database.
...
// Called when the HTTP operation to GET the photo completes.   If all is well, we commit the photo to the database.
