...
// Routes the request to the authentication delegate if it exists, otherwise  just cancels the challenge.
...
// Completes the operation with either no error (if the response status code is acceptable)  or an error (otherwise).
