...
// Called when the reachability flags change.  We just store the flags and then  check to see if the flags meet our target criteria, in which case we stop the  operation.
- (void)reachabilitySetFlags:(NSUInteger)newValue{
...
// Called by QRunLoopOperation when the operation finishes.  We just clean up  our reachability ref.
