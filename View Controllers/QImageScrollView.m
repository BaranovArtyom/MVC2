...
// We override -layoutSubviews so that, if the image is smaller than the scroll view, it ends up centred within the scroll view (rather than stuck at the top left).
- (void)layoutSubviews {
